...
import { ArrowRight, Shield, Activity, Target, PieChart, Lock } from "lucide-react";
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-12 lg:py-24 grid lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-8">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/dashboard">
              <Button size="lg" className="h-14 px-8 text-lg rounded-full bg-primary hover:bg-primary/90 shadow-[0_0_30px_-10px_rgba(59,130,246,0.5)]">
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur-xl shadow-2xl p-2">
            <CardContent className="p-8 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Link href="/dashboard">
                  <Button className="w-full h-12 text-lg bg-emerald-500 hover:bg-emerald-600 text-white">
                    Sign In
                  </Button>
                </Link>
              </div>
